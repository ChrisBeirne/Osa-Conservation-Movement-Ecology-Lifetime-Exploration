...
write.table(peru_summary, "clipboard", sep="\t", row.names=FALSE, col.names=T)
...
```{r}
all_summary %>%
  kbl(caption = "Summary: Locations and individuals by country", row.names=F) %>%
