...
This section summarizes the movement locations for all the vulture devices within Osa Conservation's movement ecology project. 
...
The project currently contains *`r length(unique(dat$tag_id))`* tag deployments. 
...
```{r c10, echo=F, include=F, message=F, warning=F}
# Create regular data
...
### Costa Rica
```{r c17, eval=T, echo=F, message=F, warning=F}
# Code derived from
